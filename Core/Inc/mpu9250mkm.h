#ifndef __MPU9250MKM_H
#define __MPU9250MKM_H
/******************************************************************************
******************************************************************************/
...
uint8_t Init_MPU9250(void);
uint8_t Init_MPU9250_New(void);
...
float Get_MPU_Temp(void);
void Display_MPU_Values(void);

float Get_MPU_AX(void);
float Get_MPU_AY(void);
float Get_MPU_AZ(void);
float Get_MPU_GX(void);
float Get_MPU_GY(void);
float Get_MPU_GZ(void);
float Get_MPU_MX(void);
float Get_MPU_MY(void);
float Get_MPU_MZ(void);

uint8_t Read_MPU_ID(void);

void Clear_MPU_Int(void);
void Mpu9250_Trigger_Wait(void);
void Read_Magnetic_Data(void);
void Diagnose_Mpu9250(void);
uint8_t Mpu9250_Freefall_Initialization(void);
void Mpu9250_Detect_FreeFall(void);
void calibrateMPU9250(float * dest1, float * dest2);
/******************************************************************************
			Developed By Manoj Kumar Meena(MKM),MAY2018 for SNSRTG-432-V10
******************************************************************************/
#endif	/*__MPU9250MKM_H*/
